...
function getColor() {
  ...
  if (w < 65) return "#22c55e";   // green (optimal)
...
function getGuidance() {
  ...
  if (w < 25) return "Reduce everything. Just exist.";
  if (w > 90 && i < 40) return "Overload. Remove input.";
  if (w > 70 && i > 60) return "You are clear. Execute.";
  if (w < 50) return "Recover slowly. No pressure.";
  return "Hold steady.";
}
